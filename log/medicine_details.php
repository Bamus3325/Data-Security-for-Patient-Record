...
if(isset($_POST['submit'])) {
  ...
  $query = "insert into `medicine_details` (`medicine_id`, `packing`, `total`) values($medicineId, '$packing', '$total');";
  try {
...
`md`.`id`, `md`.`packing`,  `md`.`medicine_id`, `md`.`total` 
from `medicines` as `m`, 
...
<head>
    ...
    <title>Medicine Details - Olalomi Patient Management System</title>
                    ...
                    <div class="card-body">
                        <form method="post">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <label>Total</label>
                                    <input id="packing" name="total" class="form-control form-control-sm rounded-0"
                                        required="required" />
                                </div>
